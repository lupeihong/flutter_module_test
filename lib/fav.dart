  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new  CupertinoNavigationBar(
        ...
        trailing: new IconButton(icon: const Icon(Icons.list), onPressed: _pushSaved),
        middle: new Text("ssssss"),
      ),
    ...
    //     leading: new IconButton(icon: const Icon(Icons.backspace)),
    //     middle: new Text("data"),
    //   ),
    //   child: new Container(),
    // );
